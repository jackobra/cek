<template>
 <nav>
  ...
  <!-- partial -->
    ...
    <div class="flex">
      <div class="container">
        <div id="myDiv1" class="box box-1" style="--img: url(IG.png)" data-text="1"></div>
        <div id="myDiv2" class="box box-2" style="--img: url(poster.png)" data-text="2"></div>
        <div id="myDiv3" class="box box-3" style="--img: url(poster2.png)" data-text="3"></div>
        <div id="myDiv4" class="box box-4" style="--img: url(pd.png)" data-text="4"></div>
        <div id="myDiv5" class="box box-5" style="--img: url(yt.png)" data-text="5"></div>
    </div>
    </div>  
